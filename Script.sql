...
INSERT INTO `citasmedicas2` (`id`, `title`, `Medico`, `Paciente`, `color`, `Textcolor`, `Observacion`, `start`, `Estado`) VALUES
	...
	(14, 'Cita', '7', '02147811', '#ff0000', '#FFFFFF', 'dolor de muelas', '2019-06-28 02:10:00', 'Pendiente'),
	(15, 'Cita', '8', '78965587', '#ff0000', '#FFFFFF', 'sdfsd', '2019-06-23 12:12:00', 'Pendiente'),
	(16, 'Cita', '7', '78965587', '#ff0000', '#FFFFFF', 'loca', '2019-06-30 03:00:00', 'Pendiente');
...
INSERT INTO `consulta` (`Dni`, `Numero`, `Estado`, `Partes`, `Fecha`) VALUES
	...
	(' 2147811', '4', 'Incrustacion', 'Distal', '2019-06-29 21:35:52'),
	(' 78965587', '5', 'Incrustacion', 'Distal', '2019-06-30 13:30:38'),
	(' 78965587', '26', 'Cariado', 'Incisal', '2019-07-01 00:06:27'),
	(' 78965587', '17', 'Cariado', 'Mesial', '2019-07-01 00:06:36');
...
-- Volcando datos para la tabla dentista2.enfermedades: ~8 rows (aproximadamente)
...
INSERT INTO `enfermedadiente` (`Dni`, `Diente`, `Enfemedad`, `Fecha`, `Ncita`) VALUES
	('45713875', '4', 'Caries ', '2019-06-27 07:29:08', 0),
	('2147811', '7', 'Anodoncia ', '2019-06-27 13:37:06', 0),
	('2147811', '18', 'Caries ', '2019-06-27 13:37:28', 0),
	('2147811', '25', 'Halitosis', '2019-06-27 13:38:00', 0),
	('78965587', '1', 'Anodoncia ', '2019-07-01 00:09:33', 16),
	('78965587', '5', 'Sindrome de la denticion', '2019-07-01 00:10:53', 16),
	('78965587', '26', 'Dientes Embetidos', '2019-07-01 00:43:14', 16);
...
-- Volcando estructura para tabla dentista2.nombredientes
CREATE TABLE IF NOT EXISTS `nombredientes` (
  `numero` int(100) DEFAULT NULL,
  `nombre` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla dentista2.nombredientes: ~15 rows (aproximadamente)
/*!40000 ALTER TABLE `nombredientes` DISABLE KEYS */;
INSERT INTO `nombredientes` (`numero`, `nombre`) VALUES
	(1, '3er Molar-Superior'),
	(2, '2do Molar-Superior'),
	(3, '1er Molar-Superior'),
	(4, '2do PreMolar-Superior'),
	(5, '1er PreMolar-Superior'),
	(6, 'Canino-Superior'),
	(7, 'Incisivo Lateral-Superior'),
	(8, 'Incisivo Central-Superior'),
	(9, 'Incisivo Central-Superior'),
	(10, 'Incisivo Lateral-Superior'),
	(11, 'Canino-Superior'),
	(12, '1er PreMolar-Superior'),
	(13, '2do PreMolar-Superior'),
	(14, '1er Molar-Superior'),
	(15, '2do Molar-Superior'),
	(16, '3er Molar-Superior'),
	(17, '3er Molar-Inferior'),
	(18, '2do Molar-Inferior'),
	(19, '1er Molar-Inferior'),
	(20, '2do PreMolar-Inferior'),
	(21, '1er PreMolar-Inferior'),
	(22, 'Canino-Inferior'),
	(23, 'Incisivo Lateral-Inferior'),
	(24, 'Incisivo Central-Inferior'),
	(25, 'Incisivo Central-Inferior'),
	(26, 'Incisivo Lateral-Inferior'),
	(27, 'Canino-Inferior'),
	(28, '1er PreMolar-Inferior'),
	(29, '2do PrrMolar-Inferior'),
	(30, '1er Molar-Inferior'),
	(31, '2do Molar-Inferior'),
	(32, '3er Molar-Inferior');
/*!40000 ALTER TABLE `nombredientes` ENABLE KEYS */;
...
INSERT INTO `pacientes` (`Codigo`, `Nombres`, `Apellido`, `Dni`, `NumeroTelefono`, `Direccion`, `Email`, `Enfermedad`, `Alergia`, `Sexo`, `Fechanaci`) VALUES
	(6, 'juan carlos', 'caceres', '45713875', '+51952802752', 'los sauces 2da etapa', 'jcarlossenati@gmail.com', 'ninguna', 'nada', 'masculino', '28/0301989'),
	(7, 'Andrea', 'cepelio', '78965587', '+5170780835', 'lima peru', 'Adnrea', 'Ninguna', 'Ninguna', 'Femenino', '12/12/1980'),
	(8, 'Angela ', 'Balaguer', '55447788', '+51987445502', 'Casa', 'Angela@gmail.com', 'niguna', 'niguna', 'femenino', '12/05/1990'),
	(9, 'Fiorela', 'valles', '02147811', '+51963001112', 'calle zela', 'fio@gmail.com', 'nada', 'nada', 'femenino', '22/8/1191'),
	(10, 'loasdf', 'sdfadsf', '3453534', '+51 970780836', 'casa', 'jcarlossenati@gmail.omc', 'asdfas', 'dsf', 'madcho', '18/18/18');
...
INSERT INTO `procepaciente` (`Dni`, `Diente`, `Procedimiento`, `Costo`, `Fecha`, `Ncita`) VALUES
	('45713875', '4', 'Sacada de Caries Dental-Alto', '30.00', '2019-06-27 07:29:43', 0),
	('2147811', '7', 'Curacion -Baja', '20.00', '2019-06-29 20:50:39', 14),
	('2147811', '18', 'Obturacion-Baja', '50.00', '2019-06-29 20:50:56', 14),
	('2147811', '18', 'Obturacion-Baja', '50.00', '2019-06-29 20:50:56', 14),
	('78965587', '5', 'Curacion -Baja', '20.00', '2019-07-01 00:43:38', 16);
...
-- Volcando datos para la tabla dentista2.tarifas: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla dentista2.usuarios: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`Codigo`, `Nombre`, `Clave`, `Nivel`) VALUES
	('222', 'alejando peralta', '123456', 'Empleado'),
